...
/* "gb/collections/inttovector.pxd":10
 * 
 * 
...
/* "gb/collections/inttovector.pxd":15
 *     size_t capacity
 * 
...
/* "gb/collections/inttovector.pyx":16
 * 
 * 
 * cdef class IntToVector(object):             # <<<<<<<<<<<<<<
 * 
...
static const char __pyx_k_IntToVector[] = "IntToVector";
...
static PyObject *__pyx_n_s_IntToVector;
...
static int __pyx_pw_2gb_11collections_11inttovector_11IntToVector_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_proc)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_init_capacity)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_n_proc = __Pyx_PyInt_As_size_t(values[0]); if (unlikely((__pyx_v_n_proc == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_init_capacity = __Pyx_PyInt_As_size_t(values[1]); if (unlikely((__pyx_v_init_capacity == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
  }
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "gb/collections/inttovector.pyx":21
 *         self.vectors = <vector *> malloc(n_proc * sizeof(vector))
 *         if self.vectors == NULL:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "gb/collections/inttovector.pyx":25
 *         cdef size_t i
 *         for i in range(n_proc):
 *             self.vectors[i].data = \             # <<<<<<<<<<<<<<
 *                 <double *> malloc(init_capacity * sizeof(double))
 ...
 */
  ...
  /* "gb/collections/inttovector.pyx":31
 *             self.vectors[i].capacity = init_capacity
 *             self.vectors[i].size = 0
 *         self.n_proc = n_proc             # <<<<<<<<<<<<<<
 * 
...
/* "gb/collections/inttovector.pyx":33
 *         self.n_proc = n_proc
 * 
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
 *         cdef size_t i
 ...
 */
    ...
    /* "gb/collections/inttovector.pyx":39
 *                 if self.vectors[i].data != NULL:
 *                     free(self.vectors[i].data)
 *             free(self.vectors)             # <<<<<<<<<<<<<<
 * 
...
/* "gb/collections/inttovector.pyx":41
 *             free(self.vectors)
 * 
 *     cdef void reset(self) nogil:             # <<<<<<<<<<<<<<
 *         cdef size_t i
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "gb/collections/inttovector.pyx":44
 *         cdef size_t i
 *         for i in range(self.n_proc):
 *             self.vectors[i].size = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "gb/collections/inttovector.pyx":49
 *         if self.vectors[i].size == self.vectors[i].capacity:
 *             self.vectors[i].capacity *= 2
 *             self.vectors[i].data = \             # <<<<<<<<<<<<<<
 *                 <double *> realloc(self.vectors[i].data,
 ...
 */
  ...
  /* "gb/collections/inttovector.pyx":55
 *                 abort()
 *         self.vectors[i].data[self.vectors[i].size] = value
 *         self.vectors[i].size += 1             # <<<<<<<<<<<<<<
 * 
...
static size_t __pyx_f_2gb_11collections_11inttovector_11IntToVector_get_size(struct __pyx_obj_2gb_11collections_11inttovector_IntToVector *__pyx_v_self, size_t __pyx_v_i) {
  ...
  /* "gb/collections/inttovector.pyx":58
 * 
 *     cdef size_t get_size(self, size_t i) nogil:
 *         return self.vectors[i].size             # <<<<<<<<<<<<<<
 * 
...
static double *__pyx_f_2gb_11collections_11inttovector_11IntToVector_get_values(struct __pyx_obj_2gb_11collections_11inttovector_IntToVector *__pyx_v_self, size_t __pyx_v_i) {
  ...
  /* "gb/collections/inttovector.pyx":61
 * 
 *     cdef double *get_values(self, size_t i) nogil:
 *         return self.vectors[i].data             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_IntToVector, __pyx_k_IntToVector, sizeof(__pyx_k_IntToVector), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyType_Ready(&__pyx_type_2gb_11collections_11inttovector_IntToVector) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_2gb_11collections_11inttovector_IntToVector.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_2gb_11collections_11inttovector_IntToVector.tp_dictoffset && __pyx_type_2gb_11collections_11inttovector_IntToVector.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_2gb_11collections_11inttovector_IntToVector.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (__Pyx_SetVtable(__pyx_type_2gb_11collections_11inttovector_IntToVector.tp_dict, __pyx_vtabptr_2gb_11collections_11inttovector_IntToVector) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_IntToVector, (PyObject *)&__pyx_type_2gb_11collections_11inttovector_IntToVector) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_2gb_11collections_11inttovector_IntToVector) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initinttovector(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initinttovector(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_inttovector(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_inttovector(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_inttovector(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'inttovector' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_inttovector(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gb.collections.inttovector", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
